...
import 'package:pees/Teacher_Dashbord/Pages/Teaching_Plans/teaching_plan_screen.dart';
...
class TeachhingPalnStudList extends StatefulWidget {
  const TeachhingPalnStudList({super.key});

  @override
  State<TeachhingPalnStudList> createState() => _TeachhingPalnStudListState();
}

class _TeachhingPalnStudListState extends State<TeachhingPalnStudList> {
  ...
  viewDetailsAction(StudentModel model) async {
    ...
    //     builder: (context) => TeachingPlanScreen(model: model));
                          ...
                          child: Padding(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return studentItems(currentList[index], isMobile);
                              },
                            ),
                          ),
                        ),
