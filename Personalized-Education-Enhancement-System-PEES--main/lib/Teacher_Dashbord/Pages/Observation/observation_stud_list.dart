...
class ObservationStudList extends StatefulWidget {
  const ObservationStudList({super.key});

  @override
  State<ObservationStudList> createState() => _ObservationStudListState();
}

class _ObservationStudListState extends State<ObservationStudList> {
  ...
  viewDetailsAction(StudentModel model) async {
    ...
    //     builder: (context) => ObservationScreen(model: model));
