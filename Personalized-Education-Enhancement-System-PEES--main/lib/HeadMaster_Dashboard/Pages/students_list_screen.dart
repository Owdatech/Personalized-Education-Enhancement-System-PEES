...
import 'package:pees/HeadMaster_Dashboard/Pages/student_details.dart';
...
class _StudentListScreenState extends State<StudentListScreen> {
  ...
  viewDetailsAction(StudentModel model) async {
    ...
    Route route = MaterialPageRoute(
        builder: (context) => StudentDetailsScreen(studentId: model.studentId));
  ...
  fetchDetails() async {
    List<StudentModel>? models = await viewModel.fetchStudentListHeadmaster();
    if (models != null) {
      model = models.first;
    }
  }
                          ...
                          child: Padding(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return studentItems(
                                    currentList[index], isMobile, searchText);
                              },
                            ),
                          ),
                        ),
  ...
  Widget studentItems(StudentModel model, bool isMobile, String searchedText) {
